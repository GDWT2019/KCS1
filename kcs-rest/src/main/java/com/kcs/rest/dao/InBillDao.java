...
public interface InBillDao {
    ...
    List<inBillShow> inBillShowPage(@Param("front")int before,@Param("back") int after,@Param("time1") String time1,@Param("time2") String time2,@Param("itemName") String itemName,@Param("username") String username,@Param("checkStatus") Integer checkStatus);
    ...
    int countReload(@Param("time1") String time1,@Param("time2") String time2,@Param("itemName") String itemName,@Param("username") String username,@Param("checkStatus") Integer checkStatus);
