    ...
    <div class="layui-col-lg12" style="padding: 10px 10px;">
        <div class=" layui-col-lg12" style="padding: 10px 15px; border-radius: 5px;">
            ...
            <div class="layui-col-lg12 " style="margin:30px 0;padding:10px;border-radius: 5px;">
                            ...
                            <table class="layui-table" id="table">
                                ...
                                <tr id="1">
                                    ...
                                    <td style="white-space: nowrap;width: 200px">
                                        <a id="addGoods" style="display: inline"><i
                                                class="layui-icon layui-icon-add-circle"
                                                style="font-size: 25px;display: inline"></i></a>
                ...
                <a href="javascript:window.print()" class="layui-btn noprint" target="_self">打印</a>
                <div class="layui-inline noprint" title="打印" onclick=preview()>
                    <i class="layui-icon layui-icon-face-smile noprint" style="font-size: 30px; color: #1E9FFF;">&#xe621;</i>
                </div>
                <div class="layui-row noprint">
                    <div style="float: right; margin-right: 30px;margin-top: 10px">
                        <button onclick="checkInBill()" class="layui-btn layui-btn-lg noprint">
                            提交入库单
                        </button>
                    </div>
                </div>
...
<script>
    ...
    function preview()
    {
        ...
        window.print();
        /*var newWin = window.open(window.document.URL,"_blank");
        var bdhtml=newWin.document.body.innerHTML;//获取当前页的html代码
        alert("bdhtml"+bdhtml);
        var startStr="<!--startprint-->";//设置打印开始区域
        var endStr="<!--endprint-->";//设置打印结束区域
        var printHtml=bdhtml.substring(bdhtml.indexOf(startStr)+startStr.length,bdhtml.indexOf(endStr));//从标记里获取需要打印的页面
        var bdhtml1=window.document.body.innerHTML;//获取当前页的html代码
        alert("bdhtml1"+bdhtml1);
        var startStr1="<!--startprint-->";//设置打印开始区域
        var endStr1="<!--endprint-->";//设置打印结束区域
        var printHtml1=bdhtml1.substring(bdhtml1.indexOf(startStr1)+startStr1.length,bdhtml1.indexOf(endStr1));//从标记里获取需要打印的页面

        alert("printHtml"+printHtml);
        alert("printHtml"+printHtml1);*/
        // newWin.document.body.innerHTML = printHtml; //将打印的部分赋值给新打开的标签页
        // newWin.print();
        // newWin.close();//关闭打印窗口
    }
