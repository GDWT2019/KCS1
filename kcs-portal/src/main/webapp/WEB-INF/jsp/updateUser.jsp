...
<div class="layui-form" >
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input readonly="readonly" id="loginName" type="text" value="${user.loginName}" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">用户名</label>
        <div class="layui-input-inline">
            <input type="text" id="userName" value="${user.userName}" name="userName" lay-verify="userName" placeholder="用户名" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-inline">
        ...
        <div class="layui-input-inline">
            <select id="positionID" name="positionID" lay-verify="required" lay-search="" lay-filter="position">
                <option value="${user.positionID}">${user.positionName}</option>
            </select>
        </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="tel" id="tel" value="${user.tel}" name="tel" lay-verify="required|phone" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">验证邮箱</label>
            <div class="layui-input-inline">
                <input type="text" id="email" value="${user.email}" name="email" lay-verify="email" autocomplete="on" class="layui-input">
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea name="note" id="note" value="${user.note}" placeholder="请输入内容" class="layui-textarea"></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
