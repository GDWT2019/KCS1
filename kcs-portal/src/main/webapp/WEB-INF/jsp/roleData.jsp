...
<script type="text/html" id="barDemo">
    {{#  if(d.roleName =='USER'||d.roleName=='ADMIN'){ }}
                   <a class="layui-btn layui-btn-disabled layui-btn-xs" >编辑</a>
                   <a class="layui-btn layui-btn-disabled layui-btn-xs" >删除角色</a>
                  {{#  } else { }}
...
<script type="text/html" id="bar">
     {{#  if(d.roleName =='USER'||d.roleName=='ADMIN'){ }}
                    <a class="layui-btn layui-btn-disabled layui-btn-xs">详情</a>
                  {{#  } else { }}
...
<script>
    ...
    layui.use(['table', 'tablePlug'], function () {
        ...
        <%--else { return '<a class="layui-btn layui-btn-xs" lay-event="detail">详情</a>'}}}--%>
